...
\begin{enumerate}
    ...
    \begin{itemize}
        \item[A.] Barrido alternado: Se emplea cuando la velocidad de barrido es elevada. En un barrido se muestra un canal, y en el siguiente el otro.
        \item[B.] Barrido troceado (Chop): Se emplea cuando la velocidad de barrido es baja. Dentro de cada ciclo de barrido se va alternado cada uno de los canales.
    \end{itemize}
