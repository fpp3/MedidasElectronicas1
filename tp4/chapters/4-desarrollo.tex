...
La constante del divisor de tensión $k_{\text{div}}$ se calcula como:
\begin{equation}
    k_{\text{div}} = \frac{R_a + R_b}{R_b} = \frac{86,7\kohm + 9,88\kohm}{9,88\kohm} = 9,7753
\end{equation}
...
\begin{equation}
    \sin\phi = \frac{A}{B} = \frac{5,2}{5,5} = 0,9455
\end{equation}

A partir de esta relación se deduce el ángulo y sus parámetros asociados:
\begin{gather}
...
\begin{itemize}
    \item \textbf{Potencia Aparente ($S$):}
          \begin{equation}
              S = V_{\text{linea}} \cdot I_{\text{linea}} = 227,15\V \cdot 0,36\A = 81,77\text{ VA}
          \end{equation}
    \item \textbf{Potencia Activa ($P$):}
          \begin{equation}
              P = S \cdot \cos\phi = 81,77\text{ VA} \cdot 0,325 = 26,57\W
          \end{equation}
    \item \textbf{Potencia Reactiva ($Q$):}
          \begin{equation}
              Q = S \cdot \sin\phi = 81,77\text{ VA} \cdot 0,945 = 77,27\text{ VAR}
          \end{equation}
\end{itemize}

\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.6\textwidth]{pictures/osc_v_xy.jpg}
...
se calcula como:
\begin{equation}
    C = \frac{P \cdot \tan\phi}{V_{\text{linea}}^2 \cdot \omega} = \frac{26,57\W \cdot 2,902}{(227,15\V)^2 \cdot 2\pi \cdot 50\Hz} \approx 4,756\uF
\end{equation}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.5\textwidth]{pictures/lcr_meter_cap.jpg}
...
\begin{gather}
    ...
    V_{C2,\text{ef}} = 1,348\V \implies I_{\text{linea}} = \frac{1,348\V}{10\ohm} = 0,1348\A
\end{gather}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.6\textwidth]{pictures/osc_v_corrected.jpg}
...
\begin{figure}[!ht]
    ...
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{pictures/square_wave_dmm.jpg}
    ...
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{pictures/square_wave_dmm_2.jpg}
...
\begin{figure}[!ht]
    ...
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{pictures/dimmer_setup_close.jpg}
        \caption{Conexiones y circuito dimmer.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{pictures/wattmeter.jpg}
